...
<script src="//code.jquery.com/ui/1.8.18/jquery-ui.min.js"></script>
	...
	$(function(){
		...
		$("#check1").click(function(){
			$("ul").empty();
				var li = $("<li>").css("color" , "black").html("<select name = from> <option value='1' selected = 'selected'>ICN</option><option value='2'>NRT</option><option value='3'>FUK</option></select>&nbsp;<select name = to><option value='1' selected = 'selected'>ICN</option><option value='2'>NRT</option><option value='3'>FUK</option></select>&nbsp;<input type='text' id='datepicker1'> ~ <input type='text' id='datepicker2'>");
